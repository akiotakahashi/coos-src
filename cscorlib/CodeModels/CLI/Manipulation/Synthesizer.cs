...
namespace CooS.CodeModels.CLI.Manipulation {
	...
	class Synthesizer {
		...
		private Synthesizer(AssemblyDef assembly) {
		...
		public static SuperType NullType {
			get {
				if(nullType==null) {
					nullType = (SuperType)CooS.Management.AssemblyResolver.Manager.ResolveType("CooS.CodeModels.CLI.Manipulation.NullType",true);
				}
				return nullType;
			}
		}
