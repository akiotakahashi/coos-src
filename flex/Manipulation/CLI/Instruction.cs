...
namespace CooS.Manipulation.CLI {
	...
	class Instruction : IBranchTarget {
		...
		public Instruction(AssemblyDefInfo assembly, int addr, OpCode opcode, object operand, InstructionPrefixes prefixes) {
...
#if false
		public CooS.Formats.CLI.Metadata.MDToken Token {
			get {
